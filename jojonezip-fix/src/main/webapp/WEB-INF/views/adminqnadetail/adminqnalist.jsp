...
<head>
  ...
  <link rel="stylesheet" href="/css/adminqnas.css">
</head>
<body>
  ...
  <div class="adminmp-subpage-header">
    <div class="adminmp-qnalist-header">
	  ...
	  <c:forEach var="qnas" items="${qnas}">
		<a href="/adminqnadetail?qnaId=${qnas.qna_id}" class="adminmp-qnalist-item">
			<div class="adminmp-qnalist-info">
			  <div>${qnas.product_name}&nbsp;|&nbsp;${qnas.qna_title}</div>
			  <div>${qnas.user_id} | ${qnas.qna_date}&nbsp;</div>
			</div>
			<c:choose>
			  <c:when test="${not empty qnas.qna_answer}">
